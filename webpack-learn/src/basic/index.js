...
function component() {
  ...
  element.innerHTML = `
        ...
        <ol>
            <li>${heroNames.heroes[0]["hero-name"]}, ${
    heroNames.heroes[0]["comics-company"]
  }</li>
            <li>${heroNames.heroes[1]["hero-name"]}, ${
    heroNames.heroes[1]["comics-company"]
  }</li>
            <li>${heroNames.heroes[2]["hero-name"]}, ${
    heroNames.heroes[2]["comics-company"]
  }</li>
        </ol>
    `;
